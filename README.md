## resource_retriever (noetic) - 1.12.10-1

The packages in the `resource_retriever` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --rosdistro noetic resource_retriever` on `Sat, 26 Apr 2025 19:34:17 -0000`
...
- rosdistro version: `1.12.9-1`
- old version: `1.12.9-1`
...
## resource_retriever (noetic) - 1.12.9-1

The packages in the `resource_retriever` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic resource_retriever` on `Thu, 10 Apr 2025 21:19:23 -0000`
...
## resource_retriever (noetic) - 1.12.8-1
